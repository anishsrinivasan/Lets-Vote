  ...
  <div class="row">
    ...
    <div class="col-md-6 section ">
      ...
      <ol>
        ...
        <li>Upload your Face and click <strong>Verify</strong></li>
   ...
   <div class="group">
    ...
    <input type="number" id="aadharnumber" name="aadharnumber" ng-model="name"><span class="highlight"></span><span class="bar"></span>
    <label>Aadhar Number:</label>
  </div>
  <div class="group">
    <input type="number" id="mobilenumber" name="mobilenumber" ><span class="highlight"></span><span class="bar"></span>
    <label>Mobile Number</label>
  </div>

  <button  type="submit" id="btnregister" class="btn btn-secondary btn-lg canvas-button  text-center" type="button ">Register</button>
...
<div class="modal facepopup fade" id="faceuploaddiv" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="group ">
    ...
    <input type="hidden" class="subject_id" id="subjectid" name="Subject ID"><span class="highlight"></span><span class="bar"></span>
  ...
  ``
    <div class="btn btn-secondary btn-lg canvas-button text-center ld-ext-right  " id="testEnroll">
  <p id="textEnroll">Upload</p>
