...
<div class="container-fluid section">
  <div class="row">
    <div class="col-md-12">
      <div class="text-center"><h1>Vote</h1>
      <br>
      <h4>General Elections 2014</h4>
      <p>Choose the party you want to cast your vote</p>
      </div>
<form action="resultentry.php" method="post"class="form-horizontal well" role="form">
        		<div class="row">
        			<div class="col-md-4 text-center section-block">
                <img src="assets/images/lannister.png" width="200px" class="img-responsive img-radio">
                <br>
                <br>
        				<button type="button" class="btn  btn-radio">House Lannister</button>
        				<input type="checkbox" name="voteresult" value="House Lannister"  id="left-item" class="invisible">
        			</div>
        			<div class="col-md-4 text-center section-block">
        				<img src="assets/images/tar.png" width="200px" class="img-responsive img-radio">
                <br>
                <br>
                <button type="button" class="btn  btn-radio">House Targaryen</button>
                <input type="checkbox" name="voteresult" value="House Targaryen" id="middle-item" class="invisible">
              
        			</div>
        			<div class="col-md-4 text-center section-block">
                <img src="assets/images/stark.png" width="200px" class="img-responsive img-radio">
                <br>
                <br>
                <button type="button" class="btn  btn-radio text-center">House Stark</button>
                <input type="checkbox" name="voteresult" value="House Stark" id="right-item" class="invisible">
                
        			</div>
            </div>
            <div class="text-center">
			<input type="hidden" name="aadharnumber" value="<?php echo $aadharnumber?>">
           <button type="submit " class="btn btn-secondary btn-lg canvas-button">Vote Now</button>
          </div>
          </form>
    </div>
  </div>
